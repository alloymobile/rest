package com.alloyfirm.tapas.rest.service;
...
@Getter
public abstract class RestRepositoryService<DBO_TYPE extends IRestDBO> {

    protected final IRestJpaRepository<DBO_TYPE> repository;

    public RestRepositoryService(IRestJpaRepository<DBO_TYPE> repository) {
